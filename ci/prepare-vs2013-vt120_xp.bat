...
cd "%BUILDDIR%"
cmake -DCMAKE_BUILD_TYPE=%CONFIG% -DSYSTEM_BOOST=ON -DBOOST_ROOT="C:/Boost" -DBOOST_LIBRARYDIR="C:/Boost/lib"  -DBOOST_INCLUDEDIR="C:/Boost/include" -DTARGET_ARCH="i386" -G"Visual Studio 12 2013" -T"v120_xp" ..
